...
<CodeRunner
  variant="guided"
  title="拆解一个真实 URL"
  prompt="任务:用 urlparse 拆解 URL,分别打印协议/主机/路径/查询参数/片段。再用 urlencode 把字典拼回查询串。提示:从 urllib.parse 导入需要的函数。"
  code={`# TODO 1: 从 urllib.parse 导入 urlparse, parse_qs, urlencode
